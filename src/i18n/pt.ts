...
export const PT: Record<string, string> = {
  ...
  Account: "Conta",
  "A trail is only visible to learners once it's published.":
    "Um trilho só é visível para quem aprende depois de publicado.",
  ...
  "Couldn't start that trail": "Não foi possível começar esse trilho",
  ...
  "Curriculum (JSON)": "Currículo (JSON)",
  "Curriculum failed to load": "O currículo não carregou",
  ...
  "Learning trails": "Trilhos de aprendizagem",
  "Leave it empty to save the metadata now and add the curriculum later. A trail can only be published once its curriculum loads.":
    "Deixa em branco para guardar só os dados agora e escrever o currículo depois. Um trilho só se publica quando o currículo carrega.",
  ...
  "Lowercase words joined by hyphens": "Palavras em minúsculas ligadas por hífenes",
  "Lv.": "Nv.",
  ...
  "Max € per recipe": "Máximo € por receita",
  Medium: "Médio",
  ...
  "This trail's curriculum lives in the repository": "O currículo deste trilho vive no repositório",
  ...
  "{name} created as a draft": "{name} criado como rascunho",
  "{name} deleted": "{name} apagado",
  "{name} is a draft again": "{name} voltou a rascunho",
  "{name} is live": "{name} está no ar",
  ...
  "1st +{xp}": "1.º +{xp}",
  "{count} photos each": "{count} fotos por pessoa",
  "{count} photo each": "{count} foto por pessoa",
  "See the result": "Ver o resultado",
  "{used}/{total} photos · add another": "{used}/{total} fotos · juntar outra",
  entrant: "participante",
  entrants: "participantes",
  "Most likes at the end wins": "Ganha quem tiver mais gostos no fim",
  "1st +{first} XP · 2nd +{second} XP · 3rd +{third} XP":
    "1.º +{first} XP · 2.º +{second} XP · 3.º +{third} XP",
  "A tie pays the same to everyone tied.": "Um empate paga o mesmo a quem empatar.",
  ...
  "{count} like": "{count} gosto",
  "{count} likes": "{count} gostos",
  "A week of soups": "Uma semana de sopas",
  "What do people have to cook, and what counts as a good entry?":
    "O que é preciso cozinhar, e o que conta como uma boa participação?",
  "XP to enter": "XP por participar",
  "Paid once per person": "Pago uma vez por pessoa",
  "Photos each": "Fotos por pessoa",
  "1 to 10": "1 a 10",
  Days: "Dias",
  "1 to 90": "1 a 90",
  Podium: "Pódio",
  ...
  "2nd": "2.º",
  "3rd": "3.º",
  "At the end, whoever has the most likes wins. A tie pays the same to everyone tied.":
    "No fim ganha quem tiver mais gostos. Um empate paga o mesmo a quem empatar.",
  "Creating…": "A criar…",
  "Create challenge": "Criar desafio",
  Running: "A decorrer",
  Closed: "Fechado",
  "To be counted": "Por apurar",
  "{count}d": "{count}d",
  "Close and pay": "Fechar e premiar",
  "You set the XP, the photos per person and how many days it runs.":
    "Defines o XP, as fotos por pessoa e quantos dias dura.",
  New: "Novo",
  "No challenges yet. Create the first one.": "Ainda não há desafios. Cria o primeiro.",
  "Challenge created": "Desafio criado",
  "Challenge updated": "Desafio atualizado",
  "Challenge deleted": "Desafio apagado",
  "Ranking closed and XP paid": "Classificação fechada e XP pago",
  ...
  "Cook another one": "Cozinhar outra",
  "Cook and enter": "Cozinhar e participar",
  "You're in {challenge}! +{xp} XP": "Estás em {challenge}! +{xp} XP",
  "Entry for the challenge": "Participação no desafio",
